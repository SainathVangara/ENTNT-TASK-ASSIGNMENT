...
const Overview = ({ onCompanySelect }) => {
  ...
  const ActionButton = selectedCompanyIds.size > 0 && (
    <button
      ...
      className="fixed bottom-6 right-6 bg-blue-600 text-white px-6 py-3 rounded-full shadow-lg hover:bg-blue-700 transition-colors flex items-center space-x-2"
    >
